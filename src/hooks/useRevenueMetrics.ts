...
const calculateRollingFromWeeklyRPC = async (
  ...
  try {
    ...
    return {
      ...
      currentFormatted: formatCurrency(currentRevenue, { inputInCents: true, excludeGST: true }),
      previousFormatted: formatCurrency(previousRevenue, { inputInCents: true, excludeGST: true }),
      previousYearFormatted: formatCurrency(yearAgoRevenue, { inputInCents: true, excludeGST: true }),
      changePercent,
      changePercentYear,
      currentAttendance,
      previousAttendance,
